...
class Prompt:
    ...
    def build_case_studies(self, case_type):
        ...
        2. Separate your answer for each article and use the format below, with the title enclosed in brackets. Use UK/ British English spelling conventions
        (e.g. generalisation, radicalisation) in writing the bullets. Each bullet must be separated by a newline:

        [Place Headline Here in brackets]
        Bullet point 1
        Bullet point 2
        Bullet point 3
